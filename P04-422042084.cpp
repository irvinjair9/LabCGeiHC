...
//===============================================================================================//
		...
		//Llantas
		model = modelaux2;
		model = glm::translate(model, glm::vec3(-2.5f, -2.5f, 2.0f));
		...
		//Primer brazo, conecta con cabina
...
//===============================================================================================//
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.45f, 0.25f, 0.1f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangular

		//Brazo 2: Articulación 1
		model = modelaux2;
		...
		color = glm::vec3(0.85f, 0.65f, 0.25f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMeshGeometry(); //dibuja cubo y pirámide triangular
		...
		//model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		modelaux2 = model;
		model = glm::scale(model, glm::vec3(3.0f, 2.0f, 7.0f));
